...
int main() {
    ...
    for (int q = 0; q < 100; q++) {
        ...
        /* unsigned char P[32] = { */
        /*     0xF, 0x0, 0xE, 0x0, 0xD, 0x0, 0xC, 0x0, 0xB, 0x0, 0xA, 0x0, 0x9, 0x0, 0x8, 0x0, */
        /*     0x7, 0x0, 0x6, 0x0, 0x5, 0x0, 0x4, 0x0, 0x3, 0x0, 0x2, 0x0, 0x1, 0x0, 0x0, 0x0 */
        /* }; */
        /* unsigned char K[32] = { */
        /*     0xF, 0x0, 0xE, 0x0, 0xD, 0x0, 0xC, 0x0, 0xB, 0x0, 0xA, 0x0, 0x9, 0x0, 0x8, 0x0, */
        /*     0x7, 0x0, 0x6, 0x0, 0x5, 0x0, 0x4, 0x0, 0x3, 0x0, 0x2, 0x0, 0x1, 0x0, 0x0, 0x0 */
        ...
        /* }; */
        /* unsigned char K[32]; */
        /* for (int i=0; i<32; i++) K[i] = P[i];//0; */

        for (int i=0; i<32; i++) {
            fprintf(in, "%01X", (int)K[31-i]);
        }

        fprintf(in, "\n");

        for (int i=0; i<32; i++) {
            fprintf(in, "%1X", (int)P[31-i]);
        }
        fprintf(in, "\n");
