...
void display_cipher_state (const unsigned char* x, const unsigned char* key, int ver) {
  int i;
...
void skinny_128_256_enc (unsigned char* input, const unsigned char* userkey) {
  enc(input,userkey,4); 
}
